...
def search(request):
    ...
    if request.method == "POST":
        ...
        #test for null
        if not searched:
            messages.success(request, "That Product is unavailable...")
...
def register_user(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(request, ("Whoops!, there was a problem registerting, please try again..."))
